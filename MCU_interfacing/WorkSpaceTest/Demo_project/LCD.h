...
#define LCD_Command_Dir             DDRD		            /*  LCD command port direction register */
#define LCD_Data_Port               PORTB		            /*  LCD data port */
#define LCD_Command_Port            PORTD		            /*  LCD data port */
#define RS                          PD0			            /*  Register Select (data/command reg.)pin */
#define RW                          PD1				        /*  Read/Write signal pin */
#define EN                          PD2	                    /*  Enable signal pin */
